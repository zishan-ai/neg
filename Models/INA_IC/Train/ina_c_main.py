...
import math
import pdb
from rlutils_ni import collect_samples, ppo_step, generate_n_candidates, convert_sentences_to_strings, expand_inputs_for_N_candidates
...
class Trainer():
    ...
    def validate_model(self, dataloader):
        ...
        f = open('exp1_output_sample_ni_i_1000.txt','a')
        with torch.no_grad():
            if not self.train_single_model:
                self.model_A.eval()
                self.model_B.eval()
...
if __name__ == '__main__':
    ...
    trainer = Trainer(modelname='model_v1_ni_1000',
                      ...
                      epsilon=0.2,
                      loadModel=False,
                      loadFilenameA="/model_v1_A1200.pth",
                      loadFilenameB="/model_v1_B1200.pth",
                      pad_token_id=2,
