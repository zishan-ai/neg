...
import math
import pdb
from rlutils_ng import collect_samples, ppo_step, generate_n_candidates, convert_sentences_to_strings, expand_inputs_for_N_candidates
...
class Trainer():
    ...
    def validate_model(self, dataloader):
        ...
        f = open('exp1_output_sample_ni_1000.txt','a')
        with torch.no_grad():
            if not self.train_single_model:
                self.model_A.eval()
                self.model_B.eval()
...
if __name__ == '__main__':
    ...
    trainer = Trainer(modelname='model_v1_ng_1000',
